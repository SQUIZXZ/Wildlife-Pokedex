...
public class SearchForAnimalService implements ISearchForAnimalService {
    ...
    public ArrayList<Animal> getAllAnimals() {
        ...
        listOfAllAnimals.add(new Animal("Common Kingfisher", "Alcedo atthis", "Bird",
        ...
        listOfAllAnimals.add(new Animal("European Blue Tit ",
                "Cyanistes caeruleus", "Bird", 10, 12,
        ...
        listOfAllAnimals.add(new Animal("Cormorant", "Phalacrocorax carbo", "Bird",
                77, 97, 121, 149,
        ...
        listOfAllAnimals.add(new Animal("Large Yellow Underwing",
                "Noctua pronuba", "Invertebrate", R.mipmap.large_yellow_underwing));
        listOfAllAnimals.add(new Animal("Long-tailed Tit",
                "Aegithalos caudatus", "Bird", 20, 34,
        ...
        listOfAllAnimals.add(new Animal("Robin", "Erithacus rubecula", "Bird",
        ...
        listOfAllAnimals.add(new Animal("Common Moorhen",
                "Gallinula chloropus", "Bird", 27, 31,
        ...
        listOfAllAnimals.add(new Animal("European Reed Warbler",
                "Acrocephalus scirpaceus", "Bird", 12, 14,
        ...
        listOfAllAnimals.add(new Animal("Whitethroat", "Sylvia communis", "Bird",
