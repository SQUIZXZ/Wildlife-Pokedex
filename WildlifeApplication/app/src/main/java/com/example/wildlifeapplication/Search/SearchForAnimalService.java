...
public class SearchForAnimalService implements ISearchForAnimalService {
    ...
    public ArrayList<Animal> getAllAnimals() {
        ...
        listOfAllAnimals.add(new Animal("Common Kingfisher", "Alcedo atthis",
                ...
                "the occasional hover", "Small, slow-flowing rivers with plenty of fish " +
                "and sometimes by lakes. They build nests in holes dug vertically into sandy banks.",
                "All year round", "Kingfishers eat fish and aquatic " +
                "insects, often caught after diving vertically", R.mipmap.common_kingfisher));
        listOfAllAnimals.add(new Animal("European Blue Tit ",
                "Cyanistes caeruleus", 10, 12, "Adults have blue wings and a yellow" +
                " front with a small black beard stripe. The tops of their heads are blue and " +
                "this is brighter in the males. Blue tits are distinguishable from Great Tits " +
                "by the blue cap on the tops of their heads and the lack of a thick black stripe" +
                " down the front of the body. When flying, the Blue Tit also lacks white down the" +
                " side of the tail feathers. Juveniles look similar to the adults, but have a" +
                " duller blue cap and yellow cheeks rather than white", "Woodland, " +
                "parks and gardens.", "All year round", "Insects, " +
                "seeds and nuts", R.mipmap.blue_tit));
        ...
        listOfAllAnimals.add(new Animal("Mute Swan", "Cygnus olor",
                ...
                "Adults are all white, with males differing by their larger size" +
                        ...
                        "rather than orange beak.", "Freshwater lakes and in coastal areas",
                "All year round", "Plants, insects and snails", R.mipmap.mute_swan));
        listOfAllAnimals.add(new Animal("Lesser Spotted Woodpecker",
                ...
                "Parks and old orchards and peck holes into dead wood to make their nests",
                "All year round", "Insects", R.mipmap.lesser_spotted_woodpecker));
        listOfAllAnimals.add(new Animal("Cormorant", "Phalacrocorax carbo",
                ...
                "Adults are all black with white cheeks. When breeding, adults " +
                        ...
                        "slower, less frequent wingbeats and a kinked neck", "Generally" +
                " coastal, but some populations winter inland. They can build nests and breed in" +
                " a variety of places including cliff-ledges, in trees or on the ground",
                "All year round","Cormorants are talented fishers, " +
                "half-leaping into dives without first looking", R.mipmap.cormorant));
        listOfAllAnimals.add(new Animal("European Green Woodpecker",
                ...
                "Woodland and parks and build their nests in holes pecked into dead wood",
        ...
        listOfAllAnimals.add(new Animal("Long-tailed Tit",
                ...
                "Woods with lots of undergrowth", "All year round",
                "These birds are mostly insectivorous, but will eat seeds in autumn" +
                        " and winter when there are fewer insects about", R.mipmap.long_tailed_tit));
        listOfAllAnimals.add(new Animal("Robin", "Erithacus rubecula",
                ...
                "pale chest and spotted with white", "Anywhere with some vegetation " +
                "and some open space including parks and garden", "All year round",
                "Invertebrates, fruit and seeds", R.mipmap.robin));
        listOfAllAnimals.add(new Animal("Common Moorhen",
                ...
                "Adults are dark grey with pale green legs and a bright red beak " +
                        ...
                        "throat", " Any small water body with dense vegetation",
                "All year round", "A variety of plants, seeds, " +
                "invertebrates and small fish", R.mipmap.common_moorhen));
        listOfAllAnimals.add(new Animal("European Reed Warbler",
                ...
                "Reed beds", "Summer", "Insectivorous in the" +
                " spring and summer, these birds eat berries in autumn to build up fat reserves" +
                " for the migration back to Africa", R.mipmap.reed_warbler));
        listOfAllAnimals.add(new Animal("Whitethroat", "Sylvia communis",
                ...
                " darting in and out of cover with tail flicks", "Farmland and along the" +
                " edges of woodland", "Summer", "Insects and berries", R.mipmap.whitethroat));
        listOfAllAnimals.add(new Animal("Great Spotted Woodpecker",
                ...
                "large white oval patches at the base of the wings", "Woodland and " +
                "parks and build their nests in holes pecked in dead wood",
                "All year round", "Insects, seeds and nuts", R.mipmap.great_spotted_woodpecker));
